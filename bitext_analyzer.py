...
input_file = codecs.open(raw_input("Enter filename: "), "r", encoding="UTF-8")

first_word = raw_input("Enter first word: ")
first_letter = first_word[0].upper()+first_word[0].lower()
fw_alt_endings = raw_input("Allow alternate endings? (y/n) ")
if fw_alt_endings == "y" :
    fw_alt_endings = ""
else :
    fw_alt_endings = "[\W\s]"
...
second_word = raw_input("Enter second word: ")
second_letter = second_word[0].upper()+second_word[0].lower()
sw_alt_endings = raw_input("Allow alternate endings? (y/n) ")
if sw_alt_endings == "y" :
    sw_alt_endings = ""
else :
    sw_alt_endings = "[\W\s]"
